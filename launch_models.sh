...
# python -m sglang.launch_server --model Qwen/Qwen2.5-72B-Instruct --tp 4 --mem-fraction-static 0.85 --trust-remote-code --host 0.0.0.0 --port 30000
python -m sglang.launch_server --model Qwen/Qwen2-7B-Instruct --tp 2 --mem-fraction-static 0.85 --trust-remote-code --host 0.0.0.0 --port 30000
...
# python -m sglang.launch_server --model /home/skabi9001/PoliTune/checkpoints/Llama-2-70b-chat-hf-DPO-Right/ --tp 2 --mem-fraction-static 0.95 --trust-remote-code --host 0.0.0.0 --port 30012
